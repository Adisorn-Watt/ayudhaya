...
//        Country c1 = Country.builder()..countryName("").build();
        ...
        Package p10 = new Package("10","Hijacking (Pay 5,000.00 Baht for every 12 consecutive hours)", 5000, new String[]{"01","02"});
        ...
        User user1 = new User("01","Mr.","Numlabyod","Reprakan","1799310717171","07/28/1998","Allianz Bank",250000,"4750317960","nearreann@gmail.com","0980159795");
